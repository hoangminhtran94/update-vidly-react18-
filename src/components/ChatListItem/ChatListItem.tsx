...
const ChatListItem: FC<{
  ...
  return (
    <div
      className=" flex relative rounded-full hover:scale-105   shadow-md border border-indigo-700 items-center cursor-pointer "
      onClick={onClick}
    >
      <Image
      ...
      />
      <p className="m-0 text-xs max-w-[50%] whitespace-nowrap overflow-hidden">
        {chatList.user.firstName}
      </p>
